            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card card-body rounded-0">
                        ...
                        <hr/>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab facilis impedit ratione reiciendis. Accusantium autem consequuntur culpa cupiditate delectus doloremque iste iure maxime necessitatibus nemo nesciunt reprehenderit, repudiandae voluptates voluptatibus!</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card card-body rounded-0">
